...
bool AllegroBase::Init( int screenWidth, int screenHeight, int fps )
{
    ...
    {
        cout << "failed to init acodec addon!" << endl;
        return false;
    }
    ...
    {
        cout << "failed to init ttf addon!" << endl;
        return false;
    }
...
void AllegroBase::Run() //changed to virtual, so i would be able to change in source.cpp
{
    // clear screen
